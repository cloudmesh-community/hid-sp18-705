...
%Taking this a step farther and also thinking about it in the context of linked data, which breaks down 
%metadata to the level of individual statements, or triples of subject-predicate-object, one could begin 
%to think about the valuation of metadata in different ways. For example, how much is a triple for a 
%subject heading worth in relation to a triple for a publication statement? The former presumably 
%requires more expertise to create, whereas the later can simply be transcribed.
